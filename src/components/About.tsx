      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <div className="space-y-6 text-lg md:text-xl text-muted leading-relaxed">
            <p>
              At ORIGIN AI, our mission is to build safe, highly capable artificial intelligence systems that augment human potential. We believe that the next era of computing will be defined by systems that can reason, learn, and adapt in real-time.
            </p>
            <p>
              Founded in 2024 by a team of leading researchers and engineers, we are tackling the hardest problems in deep learning, distributed systems, and AI alignment. Our foundational models are designed from the ground up to be efficient, transparent, and robust.
            </p>
          </div>
